...
if __name__ == "__main__":
    GT_path = './HR'
    SR_path = './SCTANet+Fourier'
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument('-GT_path', type=str,
                        default='/data/pks/DiffLLFace/dataset/CelebA/test/HR',
                        required=False, help='Path to the folder.')
    parser.add_argument('-SR_path', type=str,
                        default='/data/pks/DiffLLFace/output_DiffLLFace',
                        required=False, help='Path to the folder.')
